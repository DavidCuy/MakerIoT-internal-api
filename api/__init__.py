...
def create_app():
    ...
    from .routes import mqtt_router, device_router, deviceType_router, mongo_test_router
    ...
    app.register_blueprint(mongo_test_router, url_prefix=f'/{env.STAGE}/mongo-test')
